(function () {
  ...
  hljs.highlightAll();
  console.log("I have made so many mistakes in the previous two or three days, and even before that, I created many assumptions that caused a lot of misunderstandings and became the reason for our fights. I am truly sorry for all my wrongdoings.I want you to know that I am truly sorry for all my sins, and I am taking full responsibility for my actions. I know that my mind can sometimes go in the wrong direction, but I promise to fix it. I am not just saying that I will try, but I will do everything in my power to make things right between us.I will work hard to explain my problems clearly to you and try to solve them with your help. Your understanding means everything to me, and I am grateful for your patience and love.Lastly, I want to thank you for existing and being a part of my life. Your presence makes everything better, and I am lucky to have you in my life. Once again, I am sorry for my behavior, and I hope we can move forward together.")
